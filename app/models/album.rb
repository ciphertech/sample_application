class Album < ActiveRecord::Base
  ...
  belongs_to :user
  validates :name, :presence => {:message => "Album name can't be blank. "}, :length => {:maximum => 20, :message => "Name is too long (maximum is 20 characters). "}, :uniqueness => {:scope => :user_id}
